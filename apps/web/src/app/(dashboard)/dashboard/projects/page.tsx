...
export default function ProjectsPage() {
  const projects = [
    ...
    { name: "supabase-connector", branch: "master", url: "https://db.launchkit.dev", status: "Inactive" },
    { name: "better-auth-service", branch: "main", url: "https://auth.launchkit.dev", status: "Active" },
  ];
      ...
      <ContentWrapper>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projects.map((project, idx) => (
            <div key={idx} className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5 shadow-sm space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-neutral-950 dark:text-white">{project.name}</h3>
              ...
              <div className="flex items-center justify-between text-[11px] border-t border-neutral-100 dark:border-neutral-800 pt-3">
                <span className="flex items-center gap-1 text-neutral-500">
                  ...
                  <a href={project.url} className="hover:underline">{project.url.replace("https://", "")}</a>
                </span>
