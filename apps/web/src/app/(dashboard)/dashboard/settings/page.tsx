    ...
    <PageContainer>
      <ContentWrapper>
        <PageHeader
          ...
          description="Configure default dashboard themes, sound presets, and regional time zones."
        />
        ...
        >
          <SettingsCard
            ...
            description="Customize sidebar styles, theme parameters, and active animations."
          >
            <div className="space-y-4 max-w-md">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-neutral-500">
                    Enable system push alerts for critical security events.
                  </p>
                </div>
