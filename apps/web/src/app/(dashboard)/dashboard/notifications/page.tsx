...
export default function NotificationsPage() {
  return (
    <PageContainer>
      <ContentWrapper>
        <PageHeader
          title="Alert Stream Logs"
          description="Review all historic security notifications, billing, and team announcements."
        />

        <SettingsCard
          title="Inbox Alerts"
          description="Your system-wide notification history logs."
        >
          <div className="space-y-3">
            {[
              {
                id: 1,
                title: "Successful Auto-Renewal",
                type: "Billing",
                msg: "Monthly charge was successfully processed.",
                date: "Today",
              },
              {
                id: 2,
                ...
                type: "Security",
                msg: "Your profile password credential keys were updated.",
                date: "Yesterday",
              },
            ].map((alertItem) => (
              <div
                key={alertItem.id}
                className="flex gap-3 items-start p-3 border border-neutral-100 dark:border-neutral-800 rounded-xl"
              >
                <div className="h-8 w-8 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-neutral-500">
                  {alertItem.type === "Security" ? (
