...
export default function SupportPage() {
  return (
    <PageContainer>
      <ContentWrapper>
        <PageHeader title="Support Desk" description="Search documentation resources, ask questions, or open technical assistance tickets." />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 p-5 bg-white dark:bg-neutral-900 space-y-3">
            ...
            <h3 className="text-xs font-bold text-neutral-900 dark:text-white">Knowledgebase Docs</h3>
            <p className="text-[11px] text-neutral-500">Read setup guidelines, provider comparative tables, and RBAC instructions.</p>
          </div>

          <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 p-5 bg-white dark:bg-neutral-900 space-y-3">
            <MessageSquare className="h-6 w-6 text-emerald-600" />
            <h3 className="text-xs font-bold text-neutral-900 dark:text-white">Developer Chat</h3>
            <p className="text-[11px] text-neutral-500">Talk directly with our integration engineers in the Slack workspace community.</p>
          </div>

          <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 p-5 bg-white dark:bg-neutral-900 space-y-3">
            <Mail className="h-6 w-6 text-purple-600" />
            <h3 className="text-xs font-bold text-neutral-900 dark:text-white">Email Assistance</h3>
            <p className="text-[11px] text-neutral-500">Create a support ticket. Typical response times are within 12 hours.</p>
          </div>
        </div>

        <SettingsCard title="Open Support Ticket" description="Provide details about your technical inquiry.">
          <form className="space-y-4 max-w-lg">
            <div>
              <label className="block text-xs font-semibold text-neutral-500 uppercase">Subject</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-neutral-500 uppercase">Message</label>
              <textarea
