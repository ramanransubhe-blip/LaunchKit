...
body:
  ...
  - type: dropdown
    ...
    attributes:
      ...
      options:
        - Incorrect information (factual error, outdated content)
        - Missing documentation (undocumented feature, missing guide)
        - Unclear or confusing (hard to follow, needs better explanation)
        - Broken links or formatting (dead links, rendering issues)
        - Typo or grammar (spelling, punctuation, wording)
        - New tutorial or guide request
    validations:
      required: true
  - type: textarea
    id: location
  ...
  - type: checkboxes
    ...
    attributes:
      ...
      options:
        - label: I am willing to submit a pull request to fix this documentation issue
          required: false
